        ...
        <section className="container py-24 sm:py-32">
            <div className="mx-auto max-w-5xl text-right">
                <div className="relative">
                    <div className="absolute -right-8 -top-8 w-32 h-32 rounded-lg bg-primary/10 -z-10 dot-background" />
              ...
              <span className="absolute -bottom-2 left-0 w-full h-4 bg-primary/20 z-0"></span>
                ...
                <p className="mt-6 max-w-2xl text-lg text-left text-muted-foreground">
